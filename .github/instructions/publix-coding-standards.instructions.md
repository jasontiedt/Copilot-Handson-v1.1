---
applyTo: "**"
description: Publix-style coding standards and review expectations.
---

# Publix Coding Standards (Sample)

> Example only. Replace with the real internal standards when adapting this curriculum to a Publix repo.
