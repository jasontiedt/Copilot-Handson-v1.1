# Module 06 — Code Review & Secure Coding 🟡🔴
...
### Exercise 1 — Self-review your M03/M05 changes (20 min) 🟡

**Try this**

1. Stage all changes from M03 + M05 (`git add -p`).
...
- Author a focused review prompt — `.github/prompts/api-compat-review.prompt.md` — that flags only public-API backwards compatibility issues. Test on an M03/M05 diff.
