# Module 05 — Documentation Everywhere 🟢
...
3. Cite the related test from M04 in the **Consequences** section.
...
3. For `PriceBadge`, the prop docs should call out the `weighed` and the M04-added `salePrice` behavior.
...
- Add a `CHANGELOG.md` entry for "M04 fixes" using Conventional Commits as the source.
